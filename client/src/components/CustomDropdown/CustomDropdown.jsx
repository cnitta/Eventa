...
class CustomDropdown extends React.Component {
  ...
  componentDidMount() {
    fetch("api/items/getAllItems")
      ...
      .then(
        result => {
          this.setState({
            listItems: result.message
          });
          console.log(this.state.items + "Success is " + result.success);
        },
  ...
  handleClicked(key) {
    this.state.eventSelected = key;
    console.log(
      "trying to print the eventselected ____" + this.state.eventSelected
    );
  }
